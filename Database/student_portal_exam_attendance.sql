...
CREATE TABLE `exam_attendance` (
  ...
  KEY `exam_id` (`exam_id`),
  CONSTRAINT `exam_attendance_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `student` (`student_id`),
  CONSTRAINT `exam_attendance_ibfk_2` FOREIGN KEY (`exam_id`) REFERENCES `exam` (`exam_id`)
...
INSERT INTO `exam_attendance` VALUES (1,1,'2022-04-27 16:09:15'),(2,1,'2022-04-27 16:13:16');
